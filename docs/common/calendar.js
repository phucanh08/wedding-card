 ...
 *
 */
const tzlibVersion = "1.4.2", tzlibZonesDB = {
        Africa: {
            Abidjan: ["", 0],
...
function tzlib_get_offset(e, a, t) {
    ...
    var u = ["SU", "MO", "TU", "WE", "TH", "FR", "SA"], m = new Date(t, n, 0).getDate();
...
function tzlib_get_timezones(e = !1) {
    return 0 == tzlibZoneNames.length && (tzlibZoneNames = function () {
        var e, a, t = [];
        for ([e, a] of Object.entries(tzlibZonesDB)) if ("object" != typeof a || Array.isArray(a)) t.push(e); else for (var [n, o] of Object.entries(a)) if ("object" != typeof o || Array.isArray(o)) t.push(e + "/" + n); else for (var [i] of Object.entries(o)) t.push(e + "/" + n + "/" + i);
        return t
 ...
 *
 */
const atcbVersion = "1.18.7", isBrowser = () => "undefined" != typeof window,
    ...
    atcbValidRecurrOptions = ["apple", "google", "ical"], atcbInvalidSubscribeOptions = ["msteams"],
    atcbiOSInvalidOptions = ["ical"], atcbStates = [], atcbIcon = {
...
function atcb_decorate_data_rrule(e) {
    if (null != e.recurrence && "" != e.recurrence) if (e.recurrence = e.recurrence.replace(/\s+/g, "").toUpperCase(), /^(RRULE:[\w=;,:+-/\\]+|daily|weekly|monthly|yearly)$/im.test(e.recurrence)) if (/^RRULE:/i.test(e.recurrence)) {
...
function atcb_decorate_data_options(a) {
    ...
    for (let e = 0; e < a.options.length; e++) {
        ...
        var n = i[0].toLowerCase().replace("microsoft", "ms").replace(".", ""), o = null != i[1] ? i[1] : "";
...
function atcb_decorate_data_style(e) {
    ...
    if (null == e.lightMode || "" == e.lightMode) e.lightMode = "light"; else if (null != e.lightMode && "" != e.lightMode) {
...
function atcb_decorate_data_dates(a) {
    if (null != a.dates && 0 < a.dates.length) for (let e = 0; e < a.dates.length; e++) {
...
function atcb_date_calculation(e) {
    var a = new Date, a = a.getUTCFullYear() + "-" + (a.getUTCMonth() + 1) + "-" + a.getUTCDate(),
...
function atcb_check_required(t) {
    ...
    if (null != t.dates && 0 < t.dates.length) {
        ...
        return ["name", "startDate"].every(function (a) {
            for (let e = 0; e < t.dates.length; e++) if (!n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a]) || n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a]) && (null == t["" + a] || "" == t["" + a])) return console.error("Add to Calendar Button generation failed: required setting missing [dates array object #" + (e + 1) + "/" + t.dates.length + "] => [" + a + "]"), !1;
            return !0
        })
    }
...
function atcb_open(e, a, t = !1, n = !1) {
    if (!document.querySelector(".atcb-list") && !document.querySelector(".atcb-modal")) {
        ...
        }, 5)), atcb_set_fullsize(n), t ? o.firstChild.focus() : o.firstChild.focus({preventScroll: !0}), o.firstChild.blur()
    }
}
...
function atcb_close(a = !1) {
    ...
    if (1 < t.length) {
        ...
        t && (t.focus({preventScroll: !0}), a || t.blur()), Array.from(document.querySelectorAll(".atcb-active")).forEach(e => {
...
function atcb_generate_rich_data_recurrence(e, a) {
    ...
    return t.push('"repeatFrequency":"' + n + '"'), null != e.recurrence_byDay && "" != e.recurrence_byDay && (n = function () {
        ...
        var a = e.recurrence_byDay.split(","), t = {
...
function atcb_generate_bg_overlay(e = "dropdown", a = "", t = "light", n = !0) {
    ...
    let i = !1;
    return o.addEventListener("touchstart", atcb_debounce_leading(() => i = !1), {passive: !0}), o.addEventListener("touchmove", atcb_debounce_leading(() => i = !0), {passive: !0}), o.addEventListener("touchend", atcb_debounce(e => {
        !1 === i && e.target === e.currentTarget && atcb_toggle("close")
    }), {passive: !0}), o.addEventListener("focus", atcb_debounce_leading(e => {
        e.target === e.currentTarget && atcb_toggle("close")
...
function atcb_generate_date_button(u, e, m = "all") {
    ...
    var a = function () {
            ...
            var c = get_format_options(t), d = get_format_options(n);
...
function atcb_generate_links(e, a, t = "all", n = !1, o = !1) {
    if ("all" != t ? t = parseInt(t) - 1 : 1 == a.dates.length && (t = 0), a.subscribe) atcb_generate_subscribe_links(e, a, n); else if (!isMobile() || "msteams" != e && "ms365" != e && "outlookcom" != e || (e = "ical"), "all" != t) {
        if ("CANCELLED" == a.dates["" + t].status && "apple" != e && "ical" != e) atcb_create_modal(a, "warning", atcb_translate_hook("Cancelled Date", a), atcb_translate_hook("Delete from Calendar", a), [], [], n); else switch (e) {
            case"apple":
            case"ical":
...
function atcb_generate_subscribe_links(e, a, t) {
    ...
    switch (e) {
        ...
        case"yahoo":
            ...
            }, {label: atcb_translate_hook("Cancel", a)}], [], t);
        case"yahoo2nd":
            return atcb_copy_to_clipboard(a.icsFile), void atcb_create_modal(a, "yahoo", atcb_translate_hook("modal.subscribe.yahoo.h", a), atcb_translate_hook("modal.clipboard.text", a) + "<br>" + atcb_translate_hook("modal.subscribe.yahoo.text", a), [{
                label: atcb_translate_hook("Open Yahoo Calendar", a),
                type: "none",
...
function atcb_generate_yahoo(e) {
    var a = [], t = (a.push("https://calendar.yahoo.com/?v=60"), atcb_generate_time(e, "clean"));
...
function atcb_generate_msteams(e) {
    var a = [], t = atcb_generate_time(e, "delimiters", "microsoft");
...
function atcb_generate_ical(a, e = "all", t = !1) {
    ...
    if ("" == o || isiOS() && isWebView()) {
        ...
        var l = "all" != e ? e : 0, r = "all" != e ? e : a.dates.length - 1;
        for (let e = l; e <= r; e++) {
...
function atcb_generate_time(e, a = "delimiters", t = "general", n = !1) {
    ...
    };
    {
        var o = new Date(e.startDate + "T" + e.startTime + ":00.000+00:00"),
            i = new Date(e.endDate + "T" + e.endTime + ":00.000+00:00"), l = i - o;
        const s = Math.floor(l / 1e3 / 60 / 60), c = Math.floor((l - 60 * s * 60 * 1e3) / 1e3 / 60 % 60);
...
function atcb_position_list(e, a, t = !1, n = !1) {
    ...
    let l = e.getBoundingClientRect(), r = a.getBoundingClientRect();
...
function atcb_copy_to_clipboard(e) {
    var a, t, n = document.createElement("input"), o = (document.body.appendChild(n), n.contentEditable),
        i = n.readOnly;
...
function atcb_set_global_event_listener() {
    isBrowser() && (document.addEventListener("keyup", function (e) {
        ...
        if (document.querySelector(".atcb-list") && ("ArrowDown" === a.key || "ArrowUp" === a.key || "Tab" === a.key)) {
            let e = 0;
            var t = document.activeElement, n = document.querySelectorAll(".atcb-list-item").length;
            if (t.classList.contains("atcb-list-item")) "ArrowDown" === a.key && t.dataset.optionNumber < n ? (a.preventDefault(), e = parseInt(t.dataset.optionNumber) + 1) : "ArrowUp" === a.key && 1 <= t.dataset.optionNumber && (a.preventDefault(), e = parseInt(t.dataset.optionNumber) - 1), 0 < e && document.querySelector('.atcb-list-item[data-option-number="' + e + '"]').focus(); else switch (a.preventDefault(), a.key) {
                case"ArrowDown":
...
!function (e, t) {
    ...
    const je = () => k() && k().click(),
        ...
        He = e => {
            ...
            f().focus()
        }, De = ["ArrowRight", "ArrowDown"], qe = ["ArrowLeft", "ArrowUp"], Ve = (t, n, o) => {
